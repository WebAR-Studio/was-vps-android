...
import com.arstudio.wasvps_sdk.R
import com.arstudio.wasvps_sdk.WASVPSSdk
import com.arstudio.wasvps_sdk.ui.WASVPSArViewModel.Dialog
import kotlinx.coroutines.flow.collect
import kotlinx.coroutines.launch
import org.koin.androidx.viewmodel.ext.android.viewModel
import java.util.*

open class WASVPSArFragment : ArFragment() {
    ...
    private val viewModel: WASVPSArViewModel by viewModel()

    val vpsService: WASVPSService
        get() = viewModel

    override fun onAttach(context: Context) {
        super.onAttach(context)
        WASVPSSdk.init(context)
    }
