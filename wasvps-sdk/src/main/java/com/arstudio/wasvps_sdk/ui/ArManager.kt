...
import com.arstudio.wasvps_sdk.util.Quaternion
import com.arstudio.wasvps_sdk.util.getEulerAngles
import com.arstudio.wasvps_sdk.util.getQuaternion
import com.arstudio.wasvps_sdk.util.getTranslation
...
internal class ArManager : Scene.OnUpdateListener {
    ...
    fun init(arSceneView: ArSceneView, vpsConfig: WASVPSConfig) {
