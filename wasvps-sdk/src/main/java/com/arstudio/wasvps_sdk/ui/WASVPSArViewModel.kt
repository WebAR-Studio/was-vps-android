...
import com.arstudio.wasvps_sdk.util.hasSelfPermission
...
internal class WASVPSArViewModel(
    private val context: Context,
    private val vpsService: WASVPSService,
    private val locationManager: LocationManager
) : ViewModel(), WASVPSService by vpsService, LifecycleObserver {
    ...
    override fun startWASVPSService() {
        viewModelScope.launch {
            ...
            when {
                ...
                else -> vpsService.startWASVPSService()
            }
        }
    }
